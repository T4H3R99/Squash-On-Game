...
//    listGeneration();
  ...
  void generateRandomColumn() {
    randomcolumn1 = rnd.nextInt(3) + 1;
    randomcolumn2 = rnd.nextInt(3) + 1;
    randomcolumn3 = rnd.nextInt(3) + 1;
    if (randomcolumn1 == randomcolumn2 ||
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Stack(children: [
            Center(child: Image.asset('assets/GFDGDGDF.png')),
            Row(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                        color:
                                            Color.fromARGB(250, 191, 150, 155),
                                        border: Border.all(
